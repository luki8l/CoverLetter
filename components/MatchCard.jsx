...
export default function MatchCard({ data, isLoading, error, isPro, onRetry }) {
      ...
      <div className="p-5 sm:p-6">
        ...
        {isPro ? (
          ...
          <div className="mt-5 relative">
            {/* Blurred real content — user can almost read their own strategy */}
            <div className="blur-sm select-none pointer-events-none bg-indigo-50 border border-indigo-100 rounded-xl px-4 py-3 flex gap-3" aria-hidden="true">
              <svg className="w-4 h-4 text-indigo-500 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
              </svg>
              <div className="min-w-0">
