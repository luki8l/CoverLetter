...
import { downloadCVPDF, downloadCVDOCX } from '@/lib/export';
...
export default function CVPage() {
  ...
  async function handlePDF() {
    setExporting('pdf');
    try { await downloadCVPDF(optimizedCV); toast('PDF downloaded'); }
  ...
  async function handleDOCX() {
    setExporting('docx');
    try { await downloadCVDOCX(optimizedCV); toast('Word file downloaded'); }
    catch { toast('DOCX export failed'); }
    finally { setExporting(''); }
  }
